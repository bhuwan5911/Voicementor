...
export default function About() {
  ...
  const milestones = [
    { year: '2023', title: 'Founded VoiceBridge', description: 'Started with a vision to break barriers for rural youth' },
      ...
      <nav className="bg-white/80 backdrop-blur-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <Link href="/" className="font-pacifico text-2xl text-indigo-600">VoiceBridge</Link>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                That's why we built VoiceBridge - a platform that meets students where they are, speaks their language, 
