  ...
  const finishResumeProcess = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // No alert - just show the download button
      } else {
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-6">
              ...
              <button
                ...
                className="bg-gradient-to-r from-green-500 to-emerald-600 text-white px-4 py-2 rounded-xl hover:from-green-600 hover:to-emerald-700 transition-all shadow-lg shadow-green-500/25"
              >
            ...
            {resumeData.isComplete && (
              <div className="mt-8 text-center">
                <div className="bg-green-500/20 border border-green-500/30 rounded-xl p-6 mb-4">
                  <h3 className="text-xl font-bold text-green-400 mb-2">Resume Complete!</h3>
                  <p className="text-gray-300 mb-4">Your resume has been saved successfully. You can now download it as a PDF.</p>
                  <button
